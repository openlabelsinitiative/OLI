...
2. **[OLI Pip Package](tooling_read/python/README.md)**: Use the official OLI pip package to query the REST API for operational integrations and scripted lookups. *Ideal for Python users.*
